...
This proposed system is far more advantageous than the existing one in many cases such as retrieving the student details is easily maintained in a manner that with just one click we can easily attain the details of the company such as the responsible person's and company's contact details (address and phone numbers)  can be maintained.
...
Notice generation:
   Here user has to provide information to the system about company name, date and venue at which campus drive might take place. With this information the system will generate a notice which can be seen on
 students’ account
 to intimate students about placement drive.
...
Usability :  As the project is made using python, it has fast loading time than the website made using any other language.
...
The user interface is based on the web browser. The application is developed using JS and HTML.
