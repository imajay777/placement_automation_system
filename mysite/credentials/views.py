...
def contactview(request):
    ...
    if len(data)==0:
        ...
        p=t.render(Context({'fullname':request.user.username,'picname':piconce,'email':request.user.email,'mobile':data[0].mobile,'temp':data[0].temporary_address,'perm':data[0].permanent_address,'website':data[0].website}))
